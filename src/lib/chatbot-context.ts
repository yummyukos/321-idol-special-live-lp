...
販売ページ：https://tiget.net/events/477181
全席指定席です。当日券の販売はありません。
...
- 特典：
  - 最前列確約
  - 公演前メンバー全員との個別撮影会（30秒）
  - 公演後メンバー全員との個別チェキ会（1枚／1人ずつ）
  - メンバー全員のサイン入りオリジナル限定ブロマイドセット
  - 公演中の特別演出参加権
  - 限定グッズプレゼント
  - ファストパス入場
- ※ 公演内容を最も楽しめる超プレミアムプランです

#### 2. アリーナVIPチケット
- 料金：20,000円 + 1ドリンク
- 販売方法：抽選販売
- 特典：
  - アリーナVIPエリア確約（1〜10列目あたり）
  - 公演後メンバー全員との個別チェキ会（1枚／1人ずつ）
  - 限定ブロマイド（メンバー全員ランダム1枚）
  - ファストパス入場
...
- 特典：
  - 公演中の撮影OK（写真・動画）
  - 撮影機材持ち込み可（一眼レフ、ビデオカメラ等。三脚は不可）
  - SNS投稿OK
- ※ 推しを思いっきり撮りたい方向けのチケットです

#### 共通事項
- ドリンク代は別途必要です
- 抽選販売スケジュールは TiGET ページで確認できます
- お申し込み・お支払いは TiGET 経由で完結します
