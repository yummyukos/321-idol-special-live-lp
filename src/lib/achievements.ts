...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    threshold: 20,
    title: "衣装交換＆交換楽曲披露",
    description: "2グループで衣装をスワップ！普段見られないコラボ衣装で楽曲披露",
    icon: "👗",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    threshold: 70,
    title: "ステージ装飾ランクアップ",
    description: "ステージセットがスペシャル仕様に格上げ！照明・装花もパワーアップ",
    icon: "✨",
  },
  {
    id: 6,
    threshold: 85,
    title: "当日限定オリジナルSE制作",
    description: "登場SEをこの日のためだけに新規制作。一生に一度の音で迎える",
    icon: "🎧",
  },
  {
    id: 7,
    ...
    description: "PALE TULLE × グリッターシステム、14人全員での新曲を世界初披露",
    icon: "🎶",
  },
  {
    id: 8,
    threshold: 100,
    title: "？？？",
    description: "100%達成で解禁される、シークレット特典。当日のお楽しみに。",
    icon: "🗝️",
    mystery: true,
  },
];
